<template>
  <div class="wrap" id="app">
    <template v-if="spaLoaded">
      <top-bar></top-bar>
      <div class="wrap-in" :class="{'is-wide': isWide}">
        <menu-bar @on-collapse="onCollapse"></menu-bar>
        <div class="main-cont">
          ...
          <div
            ...
            class="loading-cont"
          >
            <img class="loading" src="./assets/image/bar.svg" alt="Container Loading">
    ...
    <template v-else>
      <div class="welcome">
        <div class="welcome-loader--wrap">
          <div class="welcome-loader"></div>
          <div class="welcome-loader--circle">
            <div class="welcome-loader--logo">
              <i class="fa fa-paper-plane"></i>
            </div>
          </div>
        </div>
        <div class="welcome-loader--text">Loading...</div>
      </div>
    </template>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...mapState('container', ['loading', 'spaLoaded'])
  },
  methods: {
    onCollapse (val) {
      this.isWide = val
...
.welcome-loader {
  ...
  border-top: 2px solid $primary-blue-color;
  border-radius: 100%;
  display: block;
  opacity: 0;
