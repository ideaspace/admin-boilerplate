<template>
  <div class="top-bar">
    ...
    <div class="top-bar--main">
      <div class="top-bar--item top-bar--item-link">
        <a href="#">文档</a>
      </div>
      <div class="top-bar--item top-bar--item-action">
        <el-select size="small" v-model="team" placeholder="请选择">
          <i class="fa fa-users" slot="prefix"></i>
          <el-option
            v-for="v in teamList"
            :key="v.value"
            :label="v.label"
        ...
        <el-dropdown class="user-meta" :hide-on-click="false">
          <span class="user-meta--name">{{user.name}}<i class="el-icon-caret-bottom el-icon--right"></i></span>
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item>
              <div class="user-meta--cont">
                <div class="user-meta--avatar">{{user.name.slice(0, 1)}}</div>
                <div class="user-meta--text">{{user.name}}</div>
              </div>
            </el-dropdown-item>
            <el-dropdown-item divided>
              <div class="user-meta--logout">退出控制台</div>
            </el-dropdown-item>
          </el-dropdown-menu>
        </el-dropdown>
      </div>
